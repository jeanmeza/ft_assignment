...
public class TestAddOwnerWithEmptyLastName extends BaseTest {
    ...
    public void TestAddOwnerWithEmptyLastNameM() throws InterruptedException {
		...
		// The last name validation message should say "must not be blank" after submitting an empty last name.
        assertEquals("must not be blank", driver.findElement(By.xpath("//input[@id='lastName']/following-sibling::span[@class='help-inline']")).getText());
